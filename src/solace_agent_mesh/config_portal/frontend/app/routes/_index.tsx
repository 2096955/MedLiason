...
export const meta: MetaFunction = () => {
  return [
    { title: "MedExpert - Config Portal" },
    { name: "description", content: "Initialize your MedExpert project or add new components." },
  ];
};
    ...
    <div className="min-h-screen bg-gray-100 py-8 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-medexpert-purple">MedExpert Configuration Portal</h1>
        </div>
