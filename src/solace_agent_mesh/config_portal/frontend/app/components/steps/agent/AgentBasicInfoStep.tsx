    ...
    <div className="space-y-6">
      ...
      >
        <textarea
          ...
          onChange={handleChange}
          rows={4}
          className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-medexpert-blue focus:border-medexpert-blue sm:text-sm"
      ...
      <div className="flex justify-end space-x-3 mt-8">
        <button
          type="button"
          onClick={onPrevious}
          className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-medexpert-blue-dark"
          disabled
        >
          Previous
        </button>
        <button
          ...
          className="px-4 py-2 text-sm font-medium text-white bg-medexpert-blue rounded-md shadow-sm hover:bg-medexpert-blue-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-medexpert-blue"
        >
          Next
        </button>
      </div>
