    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between mt-8">
        ...
        <button
          ...
          onClick={onNext}
          disabled={!canProceed}
          className="px-6 py-2 bg-medexpert-blue text-white rounded-md hover:bg-medexpert-purple-dark focus:outline-none focus:ring-2 focus:ring-medexpert-purple focus:ring-opacity-50 disabled:opacity-50"
        >
          Next
        </button>
      </div>
