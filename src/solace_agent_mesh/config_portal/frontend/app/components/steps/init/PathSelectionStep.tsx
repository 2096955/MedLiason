...
const commonOutcomes = [
  "Ready-to-use MedExpert with basic capabilities",
  ...
  return (
    <div
      ...
      className={`
        ...
        ${
          isSelected
            ? "border-medexpert-blue bg-medexpert-light-blue/10 shadow-md"
            : "border-gray-200 hover:border-medexpert-blue/50 hover:bg-gray-50"
        }
      `}
      onClick={onSelect}
    ...
    >
      <div className="flex justify-between items-start mb-4">
        <h3 className="text-xl font-bold text-medexpert-blue">{option.title}</h3>
        <span
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-6 p-4 border rounded-lg">
        <h3 className="text-lg font-semibold text-medexpert-blue mb-3">
