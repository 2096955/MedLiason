  ...
  useEffect(() => {
    const defaults: Partial<WebUIGatewayData> = {
      ...
      webui_frontend_bot_name:
        webUiGatewayData.webui_frontend_bot_name ?? "MedExpert",
    ...
    <form onSubmit={handleSubmit}>
      <div className="space-y-6">
        <InfoBox className="mb-4">
          Optionally, configure a Web UI Gateway to interact with your MedExpert
          system. This provides a Web UI chat interface.
        </InfoBox>
          ...
          <div className="space-y-4 p-4 border border-gray-200 rounded-md mt-4">
            ...
            >
              <Input
                ...
                onChange={handleChange}
                placeholder="Welcome to MedExpert!"
              />
            </FormField>
            ...
            >
              <Input
                ...
                value={webUiGatewayData.webui_frontend_bot_name || "MedExpert"}
                onChange={handleChange}
                placeholder="MedExpert"
              />
            </FormField>
