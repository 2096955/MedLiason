...
const brokerOptions = [
  { value: "solace", label: "Existing MedExpert Pub/Sub+ broker" },
  { value: "container", label: "New local MedExpert PubSub+ broker container" },
    ...
    <form onSubmit={handleSubmit}>
      <div className="space-y-6">
        ...
        {showBrokerDetails && (
          <div className="space-y-4 p-4 border border-gray-200 rounded-md">
            <InfoBox className="mb-4">
              Connect to an existing MedExpert PubSub+ broker running locally or in
        ...
        {showContainerDetails && (
          <div className="space-y-4 p-4 border border-gray-200 rounded-md">
            <InfoBox className="mb-4">
              This option will download and run a local MedExpert PubSub+ broker
