...
export const advancedInitSteps: Step[] = [
  ...
  },
  {
    id: "broker-setup",
    title: "Broker Setup",
    description: "Configure your MedExpert broker connection",
...
export default function InitializationFlow() {
  ...
  if (isLoading && currentStepIndex > 0) {
    return (
      <div className="max-w-4xl mx-auto p-6 flex flex-col items-center justify-center min-h-[400px]">
        <h1 className="text-3xl font-bold mb-8 text-medexpert-blue">
          MedExpert Initialization
        </h1>
  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto p-6">
        <h1 className="text-3xl font-bold mb-8 text-center text-medexpert-blue">
          MedExpert Initialization
        </h1>
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="mt-4 flex justify-center">
            <button
              ...
              className="bg-medexpert-blue hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
            >
              Retry
            </button>
          </div>
  ...
  if (showSuccess) {
    return (
      <div className="max-w-4xl mx-auto p-6">
        <SuccessScreen
          title="MedExpert Initialized Successfully!"
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-xl font-bold mb-2 text-medexpert-blue">
          {currentStep.title}
        </h2>
