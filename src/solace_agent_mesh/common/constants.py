...
# Product branding — use this constant in user-facing messages instead of hardcoded strings.
# The Python package remains "solace-agent-mesh" and the CLI is "sam" for backwards compatibility.
PRODUCT_NAME = "MedExpert"
...
# Extension URIs
EXTENSION_URI_SCHEMAS = "https://medexpert.com/a2a/extensions/sam/schemas"
EXTENSION_URI_AGENT_TYPE = "https://medexpert.com/a2a/extensions/agent-type"
