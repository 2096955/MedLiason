...
ENV_DEFAULTS = {
    ...
    "MEDEXPERT_BROKER_URL": "ws://localhost:8008",
    "MEDEXPERT_BROKER_VPN": "default",
    "MEDEXPERT_BROKER_USERNAME": "default",
    "MEDEXPERT_BROKER_PASSWORD": "default",
    "MEDEXPERT_DEV_MODE": "false",
...
def create_env_file(project_root: Path, options: dict, skip_interactive: bool) -> bool:
    ...
    env_params_config = [
        ...
        (
            "broker_url",
            "MEDEXPERT_BROKER_URL",
            "MedExpert Broker URL",
            False,
            "MEDEXPERT_BROKER_URL",
        ),
        (
            "broker_vpn",
            "MEDEXPERT_BROKER_VPN",
            "MedExpert Broker VPN",
            False,
            "MEDEXPERT_BROKER_VPN",
        ),
        (
            "broker_username",
            "MEDEXPERT_BROKER_USERNAME",
            "MedExpert Broker Username",
            False,
            "MEDEXPERT_BROKER_USERNAME",
        ),
        (
            "broker_password",
            "MEDEXPERT_BROKER_PASSWORD",
            "MedExpert Broker Password",
            True,
            "MEDEXPERT_BROKER_PASSWORD",
        ),
        (
            "dev_mode",
            "MEDEXPERT_DEV_MODE",
            "Enable MedExpert Dev Mode (true/false)",
            False,
            "MEDEXPERT_DEV_MODE",
        ),
        (
